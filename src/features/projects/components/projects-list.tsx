...
import { ArrowRightIcon, GlobeIcon, AlertCircleIcon, Loader2Icon } from "lucide-react";
...
const ContinueCard = ({ data }: { data: Doc<"projects">; }) => {
    return (
        <div className='flex flex-col gap-2'>
            ...
            <Button variant='outline' className='h-auto items-start justify-start p-4 bg-background border rounded-none flex flex-col gap-2' asChild>
